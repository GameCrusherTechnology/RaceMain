...
package feathers.controls
{
	...
	public class Button extends FeathersControl implements IToggle, IFocusDisplayObject
	{
		...
		{
			if(this._paddingTop == value*Configrations.ViewScale)
			{
				return;
			}
			this._paddingTop = value*Configrations.ViewScale;
			this.invalidate(INVALIDATION_FLAG_STYLES);
		}
		...
		{
			if(this._paddingRight == value*Configrations.ViewScale)
			{
				return;
			}
			this._paddingRight = value*Configrations.ViewScale;
			this.invalidate(INVALIDATION_FLAG_STYLES);
		}
		...
		{
			if(this._paddingBottom == value*Configrations.ViewScale)
			{
				return;
			}
			this._paddingBottom = value*Configrations.ViewScale;
			this.invalidate(INVALIDATION_FLAG_STYLES);
		}
		...
		{
			if(this._paddingLeft == value*Configrations.ViewScale)
			{
				return;
			}
			this._paddingLeft = value*Configrations.ViewScale;
			this.invalidate(INVALIDATION_FLAG_STYLES);
		}
